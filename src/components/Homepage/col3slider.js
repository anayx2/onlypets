...
const ProductCard = ({ id, image, name, weight, rating, originalPrice, salePrice, discount, brand }) => {
    ...
    return (
        <div className="bg-white rounded-lg md:px-3 lg:md:px-3 w-[100px] lg:w-[auto] md:w-[auto] sm:pt-4">
            <div className="p-1">
                {/* Image Section */}
                <div className="relative rounded-xl sm:mb-4 shadow-sm hover:shadow-md transition-shadow border border-gray-200 mb-1">
                    <Image src={image} alt={name} width={100} height={100} className="p-2" />
            ...
            {/* Add to Cart */}
            <button className='bg-[#FF7700] text-white rounded-lg text-[12px] p-2'>
                ADD TO CART
            </button>
...
export default CartProductSuggestion;